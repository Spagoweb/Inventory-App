...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * Edit field to enter the product's image
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentProductUri == null) {
            ...
            mProductImage.setImageResource(R.drawable.sample);
    ...
    public void remove(View view) {
        ...
        if (quantity == 0) {
            //Show error message
            Toast.makeText(this, "Can't decrease quantity to zero", Toast.LENGTH_SHORT).show();
        } else {
            quantity--;
            mQuantityEditText.setText(String.valueOf(quantity));
        }
    ...
    public void orderItem() {
        ...
        String message = "Provide us more item of this product: " +
                mNameEditText.getText().toString().trim();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (data == null) {
                Toast.makeText(this, getString(R.string.insert_image_failed), Toast.LENGTH_SHORT).show();
                return;
            }
            //Store the URI of picked image
            mImageSelect = data.getData();
            //Set it on the ImageView
            mProductImage.setImageURI(mImageSelect);
    ...
    private void saveProduct() {
        ...
        if (mCurrentProductUri == null) {
            if (mImageSelect != null) {
                imageString = mImageSelect.toString();
            }
        } else {
            imageString = mImageSelect.toString();
        }
        ...
        if (mCurrentProductUri == null &&
                ...
                TextUtils.isEmpty(supplierEmailString) && mImageSelect == null) {
        ...
        if (TextUtils.isEmpty(nameString)) {
            Toast.makeText(this, "Product name is request", Toast.LENGTH_SHORT).show();
            return;
        }
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, nameString);
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_IMG, imageString);
        ...
        // Exit activity on add and edit view
        finish();
    }
